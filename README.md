...
# Program
```
[11:45, 29/04/2025] +91 94439 79183: import numpy as np
...
```
# Output Waveform
![dc qpsk](https://github.com/user-attachments/assets/44395226-48ec-4877-be14-2f35c8af333b)

# Results
```
Thus,a python code for modulation and demodulation of QPSK is verified.
```
